...
//  Copyright © 2019 xiayingying. All rights reserved.
//

#import "YCNetworkService.h"
...
@interface YCNetworkService()

@property (nonatomic, strong) AFHTTPSessionManager  *manager;

@end

@implementation YCNetworkService
...
+ (instancetype)sharedService {
    ...
    static YCNetworkService *service;
    
    dispatch_once(&onceToken, ^{
        service = [[YCNetworkService alloc] init];
        [service initManager];
    });
